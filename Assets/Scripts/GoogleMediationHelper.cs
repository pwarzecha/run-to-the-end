...
public class GoogleMediationHelper : MonoBehaviour
{
    protected static GoogleMediationHelper instance;
    public static GoogleMediationHelper Instance
    {
        get
        {
            if (instance != null)
            ...
            instance = FindObjectOfType<GoogleMediationHelper>();
            if (instance != null)
            {
                return instance;
            }
            ...
            obj.name="Ads";
            instance = obj.AddComponent<GoogleMediationHelper>();
            return instance;
        }
    }
